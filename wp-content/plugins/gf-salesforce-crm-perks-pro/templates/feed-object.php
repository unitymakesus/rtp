...
if ( ! defined( 'ABSPATH' ) ) {
  ...
  <div class="vx_div">
        <div class="vx_head">
<div class="crm_head_div"> <?php _e('3. Select the Object to create when a form is submitted.', 'gravity-forms-salesforce-crm'); ?></div>
...
<div class="crm_clear"></div> 
  ...
  <div class="vx_group">
    <div class="vx_row">
  <div class="vx_col1">
  <label for="vx_module" class="left_header"><?php _e("Salesforce Object", 'gravity-forms-salesforce-crm'); ?>
  ...
  ?>
    ...
    <span style="margin-left: 10px;"></span>
      <button class="button" id="vx_refresh_objects" title="<?php _e('Refresh Objects','gravity-forms-salesforce-crm'); ?>">
  <span class="reg_ok"><i class="fa fa-refresh"></i> <?php _e('Refresh Objects','gravity-forms-salesforce-crm') ?></span>
  <span class="reg_proc"><i class="fa fa-refresh fa-spin"></i> <?php _e('Refreshing...','gravity-forms-salesforce-crm') ?></span>
  </button>
  <button class="button" id="vx_refresh_fields" title="<?php _e('Refresh Fields','gravity-forms-salesforce-crm'); ?>">
  <span class="reg_ok"><i class="fa fa-refresh"></i> <?php _e('Refresh Fields','gravity-forms-salesforce-crm') ?></span>
  <span class="reg_proc"><i class="fa fa-refresh fa-spin"></i> <?php _e('Refreshing...','gravity-forms-salesforce-crm') ?></span>
  </button>
  </div>
  <div class="clear"></div>
  ...
  <div id="crm_ajax_div" style="display:none; text-align: center; line-height: 100px;"><i> <?php _e('Loading, Please Wait...','gravity-forms-salesforce-crm'); ?></i></div>
