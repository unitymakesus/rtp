...
<div class="uabb-module-content uabb-image-carousel uabb-img-col-<?php echo $settings->grid_column; ?> <?php echo ( 'none' != $settings->hover_effects ) ? $settings->hover_effects : ''; ?>">
																			<?php
