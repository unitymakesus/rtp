...
[Full documentation here.](https://vip.wordpress.com/plugins/syndication/)

== Installation ==
1. Install & activate the plugin through the WordPress 'Plugins' dashboard.
1. Visit Settings > Push Syndicate Settings to configure the plugin. [Full documentation here.](https://vip.wordpress.com/plugins/syndication/)
...
<code>define('PUSH_SYNDICATE_KEY', 'this-is-a-random-key')</code>
