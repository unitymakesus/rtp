...
class WP_Network_Meta_Query {
	...
	public function get_sql( $type, $primary_table, $primary_id_column, $context = null ) {
		...
		// стандартная WordPress функция _get_meta_table() не всегда возвращала корректный результат
		global $wpdb;
		$meta_table = $wpdb->network_postmeta;
		...
		// для того, чтобы не получались такие wp_network_postmeta.network_post_id
