...
?>
<div class="fl-video fl-<?php echo ( 'media_library' == $settings->video_type ) ? 'wp' : 'embed'; ?>-video"<?php FLBuilder::print_schema( ' itemscope itemtype="https://schema.org/VideoObject"' ); ?>>
	<?php
