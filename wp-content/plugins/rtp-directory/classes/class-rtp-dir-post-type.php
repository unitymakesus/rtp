...
/**
 * RTP_Dir_Post_Type Class
 *
 * All functionality pertaining to post types in RTP_Dir.
 *
 * @package WordPress
 * @subpackage RTP_Dir
 * @category Plugin
...
class RTP_Dir_Post_Type {
	...
	public function register_taxonomy () {
		$this->taxonomies['thing-category'] = new RTP_Dir_Taxonomy(); // Leave arguments empty, to use the default arguments.
	...
	public function meta_box_content () {
		...
		$html .= '<input type="hidden" name="starter-plugin_' . $this->post_type . '_noonce" id="starter-plugin_' . $this->post_type . '_noonce" value="' . wp_create_nonce( plugin_basename( dirname( RTP_Dir()->plugin_path ) ) ) . '" />';
	...
	public function meta_box_save ( $post_id ) {
		...
		if ( ! isset( $_POST['starter-plugin_' . $this->post_type . '_noonce'] ) || ! wp_verify_nonce( $_POST['starter-plugin_' . $this->post_type . '_noonce'], plugin_basename( dirname( RTP_Dir()->plugin_path ) ) ) ) {
			return $post_id;
		}
