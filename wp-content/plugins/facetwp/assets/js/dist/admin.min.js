    ...
    (function ($) {
        ...
        function init_vue() {
            ...
            Vue.component('fselect', {
                ...
                methods: {
                    fSelectChanged: function fSelectChanged(wrap) {
                ...
                mounted: function mounted() {
                    ...
                    $().on('fs:changed', function (e) {
                        ...
                        return (ref = this$1).fSelectChanged.apply(ref, e.detail);
                    });
                },
                beforeDestroy: function beforeDestroy() {
                    var this$1 = this;

                    $().off('fs:changed', function (e) {
                        var ref;
            ...
            Vue.component('facet-settings', {
                ...
                computed: {
                    ...
                    settingsHtml: function settingsHtml() {
                        ...
                        var self = this;
                        var html = FWP.clone[this.facet.type];
                        var custom_settings = ['_code'];
