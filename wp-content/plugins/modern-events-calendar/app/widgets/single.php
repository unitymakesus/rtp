	...
	?>
		<ul class="mec-sortable">
            ...
            <li>
                ...
                <label for="<?php echo $this->get_field_id('event_speakers'); ?>"><?php _e('Event Speakers', 'mec'); ?></label>
            </li>
			<li>
			...
			<li>
                ...
                <label for="<?php echo $this->get_field_id('next_module'); ?>"><?php _e('Next Previous Module', 'mec'); ?></label>
			</li>
			<li>
