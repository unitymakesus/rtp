                        ...
                        <div class="mec-form-row wn-ticket-time">
                            <div class="mec-ticket-start-time mec-col-12">
                                ...
                                <select name="mec[tickets][<?php echo $key; ?>][ticket_start_time_ampm]">
                                    <option <?php if($ticket['ticket_start_time_ampm'] == 'AM') echo 'selected="selected"'; ?> value="AM"><?php _e('AM', 'mec'); ?></option>
                                    <option <?php if($ticket['ticket_start_time_ampm'] == 'PM') echo 'selected="selected"'; ?> value="PM"><?php _e('PM', 'mec'); ?></option>
                                </select>
                            </div>
                            <div class="mec-ticket-end-time mec-col-12">
                                ...
                                <select name="mec[tickets][<?php echo $key; ?>][ticket_end_time_ampm]">
                                    <option <?php if($ticket['ticket_end_time_ampm'] == 'AM') echo 'selected="selected"'; ?> value="AM"><?php _e('AM', 'mec'); ?></option>
                                    <option <?php if($ticket['ticket_end_time_ampm'] == 'PM') echo 'selected="selected"'; ?> value="PM"><?php _e('PM', 'mec'); ?></option>
                                </select>
                            </div>
                        </div>
                        <div class="mec-form-row">
            ...
            <div id="mec_meta_box_ticket_variations_form">
                <div class="mec-form-row">
                    <label>
                        ...
                        <input onchange="jQuery('#mec_taxes_ticket_variations_container_toggle').toggle();" value="1" type="checkbox" name="mec[ticket_variations_global_inheritance]" <?php if($global_inheritance) echo 'checked="checked"'; ?> /> <?php _e('Inherit from global options', 'mec'); ?>
                    </label>
                </div>
                            ...
                            <div class="mec-box" id="mec_ticket_variation_row<?php echo $i; ?>">
                                ...
                                <div class="mec-form-row">
                                    <span class="mec-col-4">
                                        ...
                                        <a class="mec-tooltip" title="<?php esc_attr_e('Option Price', 'mec'); ?>"><i title="" class="dashicons-before dashicons-editor-help"></i></a>
                                    </span>
                                    <span class="mec-col-4">
                                        ...
                                        <a class="mec-tooltip" title="<?php esc_attr_e('Maximum Per Ticket. Leave it blank for unlimited.', 'mec'); ?>"><i title="" class="dashicons-before dashicons-editor-help"></i></a>
                                    </span>
