                ...
                <div class="mec-form-row">
                    <div class="mec-col-4">
                        <input type="text" name="mec[date][start][date]" id="mec_start_date"
                               ...
                               placeholder="<?php _e('Start Date', 'mec'); ?>" autocomplete="off"/>
                    </div>
                ...
                <div class="mec-form-row">
                    <div class="mec-col-4">
                        <input type="text" name="mec[date][end][date]" id="mec_end_date"
                               value="<?php echo esc_attr($end_date); ?>" placeholder="<?php _e('End Date', 'mec'); ?>"
                               autocomplete="off"/>
                    </div>
                    <div class="mec-col-6 mec-time-picker
					<?php
                ...
                <div class="mec-form-row">
                    <div class="mec-col-4">
                        <input type="text" class="" name="mec[date][comment]" id="mec_comment"
                               placeholder="<?php _e('Time Comment', 'mec'); ?>"
                               value="<?php echo esc_attr($comment); ?>"/>
                        <span class="mec-tooltip">
							<div class="box top">
								<h5 class="title"><?php _e('Time Comment', 'mec'); ?></h5>
								<div class="content"><p><?php esc_attr_e('It shows next to event time on single event page. You can insert Timezone etc. in this field.', 'mec'); ?>
                ...
                <div class="mec-form-row">
                    <input
                        ...
                        ?>
                            ...
                            for="mec_repeat"><?php _e('Event Repeating', 'mec'); ?></label>
                </div>
                <div class="mec-form-repeating-event-row">
                    ...
                    <div class="mec-form-row" id="mec_repeat_certain_weekdays_container">
                        ...
                        <label> <input type="checkbox" name="mec[date][repeat][certain_weekdays][]"
                                       value="1" <?php echo(in_array(1, $certain_weekdays) ? 'checked="checked"' : ''); ?> /><?php _e('Monday', 'mec'); ?>
                        </label>
                        <label>&nbsp;<input type="checkbox" name="mec[date][repeat][certain_weekdays][]"
                                            value="2" <?php echo(in_array(2, $certain_weekdays) ? 'checked="checked"' : ''); ?> /><?php _e('Tuesday', 'mec'); ?>
                        </label>
                        <label>&nbsp;<input type="checkbox" name="mec[date][repeat][certain_weekdays][]"
                                            value="3" <?php echo(in_array(3, $certain_weekdays) ? 'checked="checked"' : ''); ?> /><?php _e('Wednesday', 'mec'); ?>
                        </label>
                        <label>&nbsp;<input type="checkbox" name="mec[date][repeat][certain_weekdays][]"
                                            value="4" <?php echo(in_array(4, $certain_weekdays) ? 'checked="checked"' : ''); ?> /><?php _e('Thursday', 'mec'); ?>
                        </label>
                        <label>&nbsp;<input type="checkbox" name="mec[date][repeat][certain_weekdays][]"
                                            value="5" <?php echo(in_array(5, $certain_weekdays) ? 'checked="checked"' : ''); ?> /><?php _e('Friday', 'mec'); ?>
                        </label>
                        <label>&nbsp;<input type="checkbox" name="mec[date][repeat][certain_weekdays][]"
                                            value="6" <?php echo(in_array(6, $certain_weekdays) ? 'checked="checked"' : ''); ?> /><?php _e('Saturday', 'mec'); ?>
                        </label>
                        <label>&nbsp;<input type="checkbox" name="mec[date][repeat][certain_weekdays][]"
                                            value="7" <?php echo(in_array(7, $certain_weekdays) ? 'checked="checked"' : ''); ?> /><?php _e('Sunday', 'mec'); ?>
                        </label>
                    </div>
                        ...
                        <div class="mec-form-row">
                            <div class="mec-col-6">
                                <input type="text" id="mec_exceptions_in_days_start_date" value=""
                                       placeholder="<?php _e('Start', 'mec'); ?>" class="mec_date_picker"/>
                                <input type="text" id="mec_exceptions_in_days_end_date" value=""
                                       placeholder="<?php _e('End', 'mec'); ?>" class="mec_date_picker"/>
                                <button class="button" type="button"
                                        id="mec_add_in_days"><?php _e('Add', 'mec'); ?></button>
                                <span class="mec-tooltip">
									<div class="box top">
										<h5 class="title"><?php _e('Custom Days Repeating', 'mec'); ?></h5>
										<div class="content"><p><?php esc_attr_e('Add certain days to event occurrence dates. If you have single day event, start and end date should be the same, If you have multiple day event the start and end dates must be commensurate with the initial date.', 'mec'); ?>
                    ...
                    <div id="mec_end_wrapper">
                        <div class="mec-form-row">
                            <label for="mec_repeat_ends_never"><h4
                                        class="mec-title"><?php _e('Ends Repeat', 'mec'); ?></h4></label>
                        </div>
                        <div class="mec-form-row">
                            <input
                                <?php
                        ...
                        <div class="mec-form-row">
                            ...
                            <span class="mec-tooltip">
								<div class="box top">
									...
									<div class="content"><p><?php esc_attr_e('The event will finish after certain repeats. For example if you set it to 10, the event will finish after 10 repeats.', 'mec'); ?>
                                            <a href="https://webnus.net/dox/modern-events-calendar/date-and-time/"
                                               target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
								</div>
								<i title="" class="dashicons-before dashicons-editor-help"></i>
                    ...
                    <div class="mec-form-row">
                        <div class="mec-col-6">
                            <input type="text" id="mec_exceptions_not_in_days_date" value=""
                                   placeholder="<?php _e('Date', 'mec'); ?>" class="mec_date_picker" autocomplete="off"/>
                            <button class="button" type="button"
            ...
            <div class="mec-form-row">
                ...
                <span class="mec-tooltip">
					<div class="box top">
						...
						<div class="content"><p><?php esc_attr_e('If you fill it, it will be replaced instead of default event page link. Insert full link including http(s):// - Also, if you use advertising URL, can use URL Shortener', 'mec'); ?>
                                <a href="https://bit.ly/"
    ...
    public function meta_box_booking_options($post)
    {
        ...
        <div id="mec-booking">
            <div class="mec-meta-box-fields" id="mec_meta_box_booking_options_form">
                <label for="mec_bookings_limit"><h4 class="mec-title"><?php _e('Total booking limits', 'mec'); ?></h4>
                </label>
                <div class="mec-form-row">
            ...
            <div class="mec-meta-box-fields" id="mec_meta_box_booking_options_form">
                <label for="mec_bookings_user_limit">
                    <h4 class="mec-title"><?php _e('Total user booking limits', 'mec'); ?></h4>
                </label>
                <div class="mec-form-row">
                    ...
                    foreach ($tickets as $key => $ticket) :
                        ...
                        <div class="mec-box" id="mec_ticket_row<?php echo $key; ?>">
							...
							<span class="mec-col-4">
								...
								<span class="mec-tooltip">
									<div class="box top">
										...
										<div class="content"><p><?php esc_attr_e('Insert 0 for free ticket. Only numbers please.', 'mec'); ?>
                            ...
                            <div class="mec-form-row">
                                ...
                                <button class="button" type="button"
                                        onclick="mec_ticket_remove(<?php echo $key; ?>);"><?php _e('Remove', 'mec'); ?></button>
                            </div>
            ...
            <div class="mec-util-hidden" id="mec_new_ticket_raw">
                <div class="mec-box" id="mec_ticket_row:i:">
                    ...
                    <div class="mec-form-row">
                        ...
                        <button class="button" type="button"
                                onclick="mec_ticket_remove(:i:)"><?php _e('Remove', 'mec'); ?></button>
                    </div>
                                    ...
                                    <span class="mec-col-4">
										...
										<span class="mec-tooltip">
											<div class="box top">
												...
												<div class="content"><p><?php esc_attr_e('Maximum Per Ticket. Leave it blank for unlimited.', 'mec'); ?>
