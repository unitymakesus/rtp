	...
	public function meta_box_dates( $post ) {
		...
		<div class="mec-meta-box-fields" id="mec-date-time">
			...
			<div id="mec_meta_box_date_form">
				...
				<div class="mec-form-row">
					<div class="mec-col-4">
						<input type="text" name="mec[date][start][date]" id="mec_start_date" value="<?php echo esc_attr( $start_date ); ?>" placeholder="<?php _e( 'Start Date', 'mec' ); ?>" autocomplete="off" />
					</div>
					...
					">
						...
						<select name="mec[date][start][ampm]" id="mec_start_ampm">
							...
							if ( $start_time_ampm == 'AM' ) {
								echo 'selected="selected"';}
							?>
							 value="AM"><?php _e( 'AM', 'mec' ); ?></option>
							<option 
							<?php
							if ( $start_time_ampm == 'PM' ) {
								echo 'selected="selected"';}
							?>
							 value="PM"><?php _e( 'PM', 'mec' ); ?></option>
						</select>
						<?php endif; ?>
					</div>
				</div>
				...
				<div class="mec-form-row">
					<div class="mec-col-4">
						<input type="text" name="mec[date][end][date]" id="mec_end_date" value="<?php echo esc_attr( $end_date ); ?>" placeholder="<?php _e( 'End Date', 'mec' ); ?>" autocomplete="off" />
					</div>
					<div class="mec-col-6 mec-time-picker 
					<?php
					if ( $allday == 1 ) {
				...
				<div class="mec-form-row">
					...
					?>
					 type="checkbox" name="mec[date][allday]" id="mec_allday" value="1" onchange="jQuery('.mec-time-picker').toggle();" /><label for="mec_allday"><?php _e( 'All Day Event', 'mec' ); ?></label>
				</div>
				<div class="mec-form-row">
					<input 
					<?php
					if ( $hide_time == '1' ) {
						echo 'checked="checked"';}
					?>
					 type="checkbox" name="mec[date][hide_time]" id="mec_hide_time" value="1" /><label for="mec_hide_time"><?php _e( 'Hide Event Time', 'mec' ); ?></label>
				</div>
				<div class="mec-form-row">
					<input 
					<?php
					if ( $hide_end_time == '1' ) {
						echo 'checked="checked"';}
					?>
					 type="checkbox" name="mec[date][hide_end_time]" id="mec_hide_end_time" value="1" /><label for="mec_hide_end_time"><?php _e( 'Hide Event End Time', 'mec' ); ?></label>
				</div>
				<div class="mec-form-row">
					<div class="mec-col-4">
						...
						<span class="mec-tooltip">
							<div class="box top">
								<h5 class="title"><?php _e('Time Comment', 'mec'); ?></h5>
								<div class="content"><p><?php esc_attr_e('It shows next to event time on single event page. You can insert Timezone etc. in this field.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/add-event/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
							</div>
			...
			<div id="mec_meta_box_repeat_form">
				<div class="mec-form-row">
					...
					if ( $repeat_status == '1' ) {
						echo 'checked="checked"';}
					?>
					 type="checkbox" name="mec[date][repeat][status]" id="mec_repeat" value="1" /><label for="mec_repeat"><?php _e( 'Event Repeating', 'mec' ); ?></label>
				</div>
							...
							<div class="mec-col-6">
								...
								<span class="mec-tooltip">
									<div class="box top">
										...
										<div class="content"><p><?php esc_attr_e('Add certain days to event occurrence dates. If you have single day event, start and end date should be the same, If you have multiple day event the start and end dates must be commensurate with the initial date.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/date-and-time/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
									</div>
									<i title="" class="dashicons-before dashicons-editor-help"></i>
								</span>	  										
							</div>
						...
						<div class="mec-form-row">
							...
							<span class="mec-tooltip">
								<div class="box top">
									...
									<div class="content"><p><?php esc_attr_e('The event will finish after certain repeats. For example if you set it to 10, the event will finish after 10 repeats.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/date-and-time/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
								</div>
								<i title="" class="dashicons-before dashicons-editor-help"></i>
							</span>	  									
						</div>
						...
						<div class="mec-col-6">
							...
							<span class="mec-tooltip">
								<div class="box top">
									...
									<div class="content"><p><?php esc_attr_e('Exclude certain days from event occurrence dates. Please note that you can exclude only single day occurrences and you cannot exclude one day from multiple day occurrences.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/exceptional-days/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
								</div>
								<i title="" class="dashicons-before dashicons-editor-help"></i>
							</span>	  									
						</div>
	...
	public function meta_box_hourly_schedule( $post ) {
		...
		<div class="mec-meta-box-fields" id="mec-hourly-schedule">
			...
			<div id="mec_meta_box_hourly_schedule_day_form">
				<div class="mec-form-row">
					<button class="button" type="button" id="mec_add_hourly_schedule_day_button"><?php _e( 'Add Day', 'mec' ); ?></button>
				...
				<div id="mec_meta_box_hourly_schedule_day_:d:">
					...
					<div id="mec_meta_box_hourly_schedule_form:d:">
						<div class="mec-form-row">
							...
							<div class="mec-col-10"><input type="text" id="mec_add_hourly_schedule_day:d:_title" name="mec[hourly_schedules][:d:][title]" value="<?php echo __( 'New Day', 'mec' ); ?>" class="widefat"></div>
			...
			<div class="mec-form-row">
				...
				<span class="mec-tooltip">
					<div class="box top">
						...
						<div class="content"><p><?php esc_attr_e('If you fill it, it will be replaced instead of default event page link. Insert full link including http(s):// - Also, if you use advertising URL, can use URL Shortener', 'mec'); ?><a href="https://bit.ly/" target="_blank"><?php _e('URL Shortener', 'mec'); ?></a></p></div>
					</div>
					<i title="" class="dashicons-before dashicons-editor-help"></i>
				</span>	  						
			</div>
			<div class="mec-form-row">
				...
				<span class="mec-tooltip">
					<div class="box top">
						...
						<div class="content"><p><?php esc_attr_e('If you fill it, it will be shown in event details page as an optional link. Insert full link including http(s)://', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/add-event/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
					</div>
					<i title="" class="dashicons-before dashicons-editor-help"></i>
				</span>	  						
			</div>
		...
		<div id="mec-booking">
			<div class="mec-meta-box-fields" id="mec_meta_box_booking_options_form">
				...
				<div class="mec-form-row">
					...
					<input class="mec-col-4" type="text" name="mec[booking][bookings_limit]" id="mec_bookings_limit" value="<?php echo esc_attr( $bookings_limit ); ?>" placeholder="<?php _e( '100', 'mec' ); ?>" class="
																																	   <?php
																																		if ( $bookings_limit_unlimited == 1 ) {
																																			echo 'mec-util-hidden';}
																																		?>
				...
				<span class="mec-tooltip">
					<div class="box">
						<h5 class="title"><?php _e('Total booking limits', 'mec'); ?></h5>
						<div class="content"><p><?php esc_attr_e('If you want to set a limit to all tickets, uncheck this checkbox and put a limitation number.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/total-booking-limits/" target="_blank"><?php _e('Read More', 'mec'); ?></a><a href="https://webnus.net/dox/modern-events-calendar/add-a-booking-system/" target="_blank"><?php _e('Read About A Booking System', 'mec'); ?></a></p></div>
					</div>
					<i title="" class="dashicons-before dashicons-editor-help"></i>
				</span>	 					
			</div>
							...
							<span class="mec-col-4">
								...
								<span class="mec-tooltip">
									<div class="box top">
										...
										<div class="content"><p><?php esc_attr_e('Insert 0 for free ticket. Only numbers please.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/add-a-booking-system/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
									</div>
									<i title="" class="dashicons-before dashicons-editor-help"></i>
								</span>	  										
							</span>
							<span class="mec-col-8">
								...
								<span class="mec-tooltip">
									<div class="box top">
										...
										<div class="content"><p><?php esc_attr_e('For showing on website. e.g. $15', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/add-a-booking-system/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
									</div>
									<i title="" class="dashicons-before dashicons-editor-help"></i>
								</span>	  										
							</span>
					...
					<div class="mec-form-row wn-ticket-time">
						<div class="mec-ticket-start-time mec-col-12">
							...
							<select name="mec[tickets][:i:][ticket_start_time_ampm]">
								<option selected="selected" value="AM"><?php _e( 'AM', 'mec' ); ?></option>
								<option value="PM"><?php _e( 'PM', 'mec' ); ?></option>
							</select>
						</div>
						<div class="mec-ticket-start-time mec-col-12">
							<span><?php esc_html_e( 'End Time', 'mec' ); ?></span>
							...
							<select name="mec[tickets][:i:][ticket_end_time_ampm]">
								<option value="AM"><?php _e( 'AM', 'mec' ); ?></option>
								<option selected="selected" value="PM"><?php _e( 'PM', 'mec' ); ?></option>
							</select>
						</div>
					</div>
					<div class="mec-form-row">
								...
								<span class="mec-col-4">
									...
									<span class="mec-tooltip">
										<div class="box top">
											...
											<div class="content"><p><?php esc_attr_e('Fee amount, considered as fixed amount if you set the type to amount otherwise considered as percentage', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/tickets-and-taxes-fees/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
										</div>
										<i title="" class="dashicons-before dashicons-editor-help"></i>
									</span>	  										
								</span>
	...
	public function meta_box_ticket_variations( $post ) {
		...
		<div class="mec-meta-box-fields" id="mec-ticket-variations">
			...
			<div id="mec_meta_box_ticket_variations_form">
				...
				">
					<div class="mec-form-row">
						<button class="button" type="button" id="mec_add_ticket_variation_button"><?php _e( 'Add', 'mec' ); ?></button>
					</div>
					<div id="mec_ticket_variations_list">
						...
						foreach ( $ticket_variations as $key => $ticket_variation ) :
							...
							<div class="mec-box" id="mec_ticket_variation_row<?php echo $i; ?>">
								<div class="mec-form-row">
									<input class="mec-col-12" type="text" name="mec[ticket_variations][<?php echo $i; ?>][title]" placeholder="<?php esc_attr_e( 'Title', 'mec' ); ?>" value="<?php echo ( isset( $ticket_variation['title'] ) ? esc_attr( $ticket_variation['title'] ) : '' ); ?>" />
								</div>
								<div class="mec-form-row">
									<span class="mec-col-4">
										<input type="text" name="mec[ticket_variations][<?php echo $i; ?>][price]" placeholder="<?php esc_attr_e( 'Price', 'mec' ); ?>" value="<?php echo ( isset( $ticket_variation['price'] ) ? esc_attr( $ticket_variation['price'] ) : '' ); ?>" />
										<span class="mec-tooltip">
											<div class="box top">
												<h5 class="title"><?php _e('Price', 'mec'); ?></h5>
									...
									<span class="mec-col-4">
										<input type="number" min="0" name="mec[ticket_variations][<?php echo $i; ?>][max]" placeholder="<?php esc_attr_e( 'Maximum Per Ticket', 'mec' ); ?>" value="<?php echo ( isset( $ticket_variation['max'] ) ? $ticket_variation['max'] : '' ); ?>" />
										<span class="mec-tooltip">
											<div class="box top">
			...
			<div class="mec-util-hidden" id="mec_new_ticket_variation_raw">
				<div class="mec-box" id="mec_ticket_variation_row:i:">
					<div class="mec-form-row">
						<input class="mec-col-12" type="text" name="mec[ticket_variations][:i:][title]" placeholder="<?php esc_attr_e( 'Title', 'mec' ); ?>" />
					</div>
					<div class="mec-form-row">
						<span class="mec-col-4">
							<input type="text" name="mec[ticket_variations][:i:][price]" placeholder="<?php esc_attr_e( 'Price', 'mec' ); ?>" />
							<span class="mec-tooltip">
								<div class="box top">
									<h5 class="title"><?php _e('Price', 'mec'); ?></h5>
									<div class="content"><p><?php esc_attr_e('Option Price', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/ticket-variations/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
						...
						<span class="mec-col-4">
							<input type="number" min="0" name="mec[ticket_variations][:i:][max]" placeholder="<?php esc_attr_e( 'Maximum Per Ticket', 'mec' ); ?>" value="1" />
							<span class="mec-tooltip">
								<div class="box top">
									<h5 class="title"><?php _e('Maximum Per Ticket', 'mec'); ?></h5>
									<div class="content"><p><?php esc_attr_e('Maximum Per Ticket. Leave it blank for unlimited.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/ticket-variations/" target="_blank"><?php _e('Read More', 'mec'); ?></a></p></div>
