...
class MEC_gateway_stripe extends MEC_gateway
{
    ...
    public function checkout_form($transaction_id, $params = array())
    {
        ...
        <div class="mec-gateway-message mec-util-hidden"
             id="mec_do_transaction_stripe_message<?php echo $transaction_id; ?>"></div>
        <?php
    }
    ...
    public function options_form()
    {
        ...
        ?>
            ...
            <div class="mec-form-row">
                ...
                <div class="mec-col-4">
                    <textarea id="mec_gateways<?php echo $this->id(); ?>_comment"
                              name="mec[gateways][<?php echo $this->id(); ?>][comment]"><?php echo (isset($this->options['comment']) and trim($this->options['comment'])) ? stripslashes($this->options['comment']) : ''; ?></textarea>
            ...
            <div class="mec-form-row">
                ...
                <div class="mec-col-4">
                    <input type="text" id="mec_gateways<?php echo $this->id(); ?>_secret_key"
            ...
            <div class="mec-form-row">
                ...
                <div class="mec-col-4">
                    <input type="text" id="mec_gateways<?php echo $this->id(); ?>_publishable_key"
...
class MEC_gateway_pay_locally extends MEC_gateway
{
    ...
    public function checkout_form($transaction_id, $params = array())
    {
        ...
        <div class="mec-gateway-message mec-util-hidden"
             id="mec_do_transaction_pay_locally_message<?php echo $transaction_id; ?>"></div>
        <?php
    }
...
class MEC_gateway_paypal_express extends MEC_gateway
{
    ...
    public function options_form()
    {
        ...
        ?>
            ...
            <div class="mec-form-row">
                ...
                <div class="mec-col-4">
                    <input type="text" id="mec_gateways<?php echo $this->id(); ?>_account"
    ...
    public function checkout_form($transaction_id, $params = array())
    {
        ...
        <form id="mec_do_transaction_paypal_express_form<?php echo $transaction_id; ?>"
        ...
        <div class="mec-gateway-message mec-util-hidden"
             id="mec_do_transaction_paypal_express_message<?php echo $transaction_id; ?>"></div>
        <?php
    }
    ...
    public function validate_express_payment($vars)
    {
        ...
        if (strpos($response_str, 'VERIFIED') !== false) {
            $status = 1;
        } else {
            $status = 0;
        }
...
class MEC_gateway_paypal_credit_card extends MEC_gateway
{
    ...
    public function options_form()
    {
        ...
        ?>
            ...
            <div class="mec-form-row">
                ...
                <div class="mec-col-4">
                    <input type="text" id="mec_gateways<?php echo $this->id(); ?>_api_username"
            ...
            <div class="mec-form-row">
                ...
                <div class="mec-col-4">
                    <input type="text" id="mec_gateways<?php echo $this->id(); ?>_api_password"
            ...
            <div class="mec-form-row">
                ...
                <div class="mec-col-4">
                    <input type="text" id="mec_gateways<?php echo $this->id(); ?>_api_signature"
    ...
    public function checkout_form($transaction_id, $params = array())
    {
        ...
        <div class="mec-gateway-message mec-util-hidden"
             id="mec_do_transaction_paypal_credit_card_message<?php echo $transaction_id; ?>"></div>
        <?php
    }
...
class MEC_gateway_woocommerce extends MEC_gateway
{
    ...
    public function checkout_form($transaction_id, $params = array())
    {
        ...
        <div class="mec-gateway-message mec-util-hidden"
             id="mec_do_transaction_woocommerce_message<?php echo $transaction_id; ?>"></div>
