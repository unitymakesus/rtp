        ...
        <div class="sync-content w-clearfix extra">
            ...
            <form id="mec_ix_sync_form" action="<?php echo $this->main->get_full_url(); ?>" method="POST">
                ...
                <div class="mec-form-row mec-syn-schedule">
                    ...
                    <h4>- <?php _e('First you need to enable above options for each to be able to use this.', 'mec'); ?></h4>
                    <h4>- <?php _e('If you cannot set Cron Job on your server, you can use the options below. Please make sure to NOT use the following options and set on the server manually together.', 'mec'); ?></h4>
