...
class MEC_feature_labels extends MEC_base
{
    ...
    ?>
        ...
        <tr class="form-field">
            <th scope="row" valign="top">
                <label for="mec_style"><?php _e('Style', 'mec'); ?></label>
            </th>
            <td>
                <select name="style" id="mec_style">
                    <option value=""><?php _e('Normal', 'mec'); ?></option>
                    <option value="mec-label-featured" <?php echo ($style == 'mec-label-featured' ? 'selected="selected"' : ''); ?>><?php _e('Featured', 'mec'); ?></option>
                    <option value="mec-label-canceled" <?php echo ($style == 'mec-label-canceled' ? 'selected="selected"' : ''); ?>><?php _e('Canceled', 'mec'); ?></option>
                </select>
                <p class="description"><?php _e('You can show featured and canceled events by a different style!', 'mec'); ?></p>
            </td>
        </tr>
    <?php
    }
    ...
    ?>
        ...
        <div class="form-field">
            ...
            <select name="style" id="mec_style">
                <option value=""><?php _e('Normal', 'mec'); ?></option>
                <option value="mec-label-featured"><?php _e('Featured', 'mec'); ?></option>
                <option value="mec-label-canceled"><?php _e('Canceled', 'mec'); ?></option>
            </select>
            <p class="description"><?php _e('You can show featured and canceled events by a different style!', 'mec'); ?></p>
        </div>
    <?php
