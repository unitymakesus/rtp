...
<head>
  ...
  <link rel='stylesheet' id='fontello-animation-css' href="<?php echo PRLI_VENDOR_LIB_URL.'/fontello/css/animation.css'; ?>" type='text/css' media='all' />
  <link rel='stylesheet' id='fontello-pretty-link-css' href="<?php echo PRLI_VENDOR_LIB_URL.'/fontello/css/pretty-link.css'; ?>" type='text/css' media='all' />
<style type="text/css">
html, body {
  margin: 0px;
  padding: 0px;
      ...
      <td class="retweet" valign="top">
        <div class="pb-cell">
          ...
          <?php if( $bar_show_share_links ) { ?>
            <a href="http://twitter.com/home?status=<?php echo urlencode( $prli_blogurl . PrliUtils::get_permalink_pre_slug_uri() . $slug ); ?>" target="_top"><?php _e('Share on Twitter'); ?></a>
          <?php } else echo "&nbsp;"; ?>
          </h4>
        </div>
      </td>
      <td valign="top">
        <div class="pb-cell right_container">
          <table width="100%" cellpadding="0" cellspacing="0" style="padding: 0px; margin: 0px;">
            <tr>
              <td>
                <p class="closebutton"><a href="<?php echo $target_url; ?>" target="_top"><i class="pl-icon pl-icon-cancel-circled pl-16"> </i></a></p>
              </td>
            </tr>
            <tr>
              <td>
                ...
                <p class="powered-by small-text"><?php _e('Powered by', 'pretty-link'); ?> <a href="https://prettylinks.com/plp/pretty-bar/powered-by" target="_top"><img src="<?php echo PRLI_IMAGES_URL; ?>/pretty-link-small.png" width="12px" height="12px" border="0"/> <?php _e('Pretty Link', 'pretty-link'); ?></a></p>
                <?php
