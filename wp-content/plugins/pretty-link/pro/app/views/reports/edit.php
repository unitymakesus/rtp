...
<div class="wrap">
  ...
  <p class="submit">
    <input type="submit" name="Submit" value="<?php _e('Update'); ?>" class="button button-primary" /> &nbsp; <a href="<?php echo admin_url('admin.php?page=plp-reports&action=list'); ?>" class="button"><?php _e('Cancel', 'pretty-link'); ?></a>
  </p>
  </form>
</div>
