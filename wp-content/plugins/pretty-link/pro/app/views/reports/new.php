...
<div class="wrap">
  ...
  <form name="form1" method="post" action="<?php echo admin_url('admin.php?page=plp-reports'); ?>">
    ...
    <table class="form-table">
      <tr class="form-field">
        ...
        <td><input type="text" name="name" value="<?php echo ((isset($_POST['name']))?$_POST['name']:''); ?>" size="75">
          <br/><span class="description"><?php _e("This is how you'll identify your Report.", 'pretty-link'); ?></span>
        </td>
      </tr>
    </table>
    <table class="form-table">
      <tr class="form-field" valign="top">
        <td width="50%" valign="top">
          ...
          <span class="description"><?php _e('Select some links to be analyzed in this report.', 'pretty-link'); ?></span>
        </td>
        <td valign="top" width="50%">
          ...
          <span class="description"><?php _e('If you want to enable conversion tracking in this report then select a goal link.', 'pretty-link'); ?></span>
        </td>
      </tr>
    </table>

    <p class="submit">
      <input type="submit" name="Submit" value="Create" class="button button-primary" /> &nbsp; <a href="<?php echo admin_url('admin.php?page=plp-reports&action=list'); ?>" class="button"><?php _e('Cancel', 'pretty-link'); ?></a>
    </p>
