...
<div class="wrap">
  ...
  <?php } ?>
  <a href="<?php echo admin_url("admin.php?page=pretty-link&action=list"); ?>" style="font-size:16px;">&laquo <?php _e('Back to Links', 'pretty-link'); ?></a>&nbsp;|&nbsp;<a href="#" style="display:inline;" class="filter_toggle"><?php _e('Customize Report', 'pretty-link'); ?></a>
  <div class="filter_pane">
    <form class="form-fields" name="form2" method="post" action="">
      ...
      <br/>
      <br/>
      <div class="submit" style="display: inline;"><input type="submit" name="Submit" value="Customize" class="button button-primary" /> &nbsp; <a href="#" class="filter_toggle button">Cancel</a></div>
    </form>
  </div>
