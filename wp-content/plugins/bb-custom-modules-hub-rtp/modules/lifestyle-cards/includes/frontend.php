        ...
        <?php for ($i = 0; $i < count($settings->cards); $i++) : ?>
            ...
            <div class="cbb-lifestyle__card">
                <div class="cbb-lifestyle__card-inner">
                    <button class="cbb-lifestyle__card-toggle" aria-expanded="false" aria-describedby="lifestyle-card-<?php echo $i; ?>">
                    <svg viewBox="0 0 10 10"><path d="m1 4h8v2h-8zm3-3h2v8h-2z" fill="#FFFFFF"/></svg>
                    </button>
                    <div class="cbb-lifestyle__card-body">
                        <div class="cbb-lifestyle__card-front" style="background-image:url(<?php echo wp_get_attachment_image_src($settings->cards[$i]->background_image, 'large')[0]; ?>);">
                        </div>
