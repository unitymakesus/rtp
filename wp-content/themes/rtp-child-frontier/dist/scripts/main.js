      ...
      value: function _makeAncestorsOverflowVisible() {
        ...
        while (ancestor !== null && !$(ancestor).is(document)) {
          ...
          if (curr.css('overflow') !== 'visible') {
            ...
            if (this$1.ancestorsChanged === undefined) {
              this$1.ancestorsChanged = curr;
            } else {
              this$1.ancestorsChanged = this$1.ancestorsChanged.add(curr);
            }
          }
      ...
      value: function _renderDropdown(data, val) {
        ...
        for (var key in data) {
          if (data.hasOwnProperty(key) && key.toLowerCase().indexOf(val) !== -1) {
            // Break if past limit
            if (this$1.count >= this$1.options.limit) {
              break;
            }
        ...
        for (var i = 0; i < matchingData.length; i++) {
          ...
          $(this$1.container).append($autocompleteOption);
          this$1._highlight(val, $autocompleteOption);
        }
      }
    ...
    _createClass(Chips, [{
      ...
      value: function _renderChips() {
        ...
        for (var i = 0; i < this.chipsData.length; i++) {
          var chipEl = this$1._renderChip(this$1.chipsData[i]);
          this$1.$el.append(chipEl);
          this$1.$chips.add(chipEl);
        }
      ...
      value: function _isValid(chip) {
        ...
        if (chip.hasOwnProperty('tag') && chip.tag !== '') {
          var exists = false;
          for (var i = 0; i < this.chipsData.length; i++) {
            if (this$1.chipsData[i].tag === chip.tag) {
              exists = true;
              break;
            }
          }
    ...
    _createClass(Datepicker, [{
      ...
      value: function render(year, month, randId) {
        ...
        for (var i = 0, r = 0; i < cells; i++) {
          var day = new Date(year, month, 1 + (i - before)),
              isSelected = Datepicker._isDate(this$1.date) ? Datepicker._compareDates(day, this$1.date) : false,
          ...
          row.push(this$1.renderDay(dayConfig));

          if (++r === 7) {
            data.push(this$1.renderRow(row, opts.isRTL, isWeekSelected));
            row = [];
            r = 0;
      ...
      value: function renderHead(opts) {
        ...
        var i = void 0,
            arr = [];
        for (i = 0; i < 7; i++) {
          arr.push("<th scope=\"col\"><abbr title=\"" + this$1.renderDayName(opts, i) + "\">" + this$1.renderDayName(opts, i, true) + "</abbr></th>");
        }
      ...
      value: function draw(force) {
        ...
        for (var c = 0; c < 1; c++) {
          this$1._renderDateDisplay();
          html += this$1.renderTitle(this$1, c, this$1.calendars[c].year, this$1.calendars[c].month, this$1.calendars[0].year, randId) + this$1.render(this$1.calendars[c].year, this$1.calendars[c].month, randId);
        }
    ...
    _createClass(Timepicker, [{
      ...
      value: function _buildHoursView() {
        ...
        if (this.options.twelveHour) {
          for (var i = 1; i < 13; i += 1) {
            ...
            var radius = this$1.options.outerRadius;
            tick.css({
              left: this$1.options.dialRadius + Math.sin(radian) * radius - this$1.options.tickRadius + 'px',
              top: this$1.options.dialRadius - Math.cos(radian) * radius - this$1.options.tickRadius + 'px'
            });
            tick.html(i === 0 ? '00' : i);
            this$1.hoursView.appendChild(tick[0]);
          ...
          for (var _i2 = 0; _i2 < 24; _i2 += 1) {
            ...
            var _radius = inner ? this$1.options.innerRadius : this$1.options.outerRadius;
            _tick.css({
              left: this$1.options.dialRadius + Math.sin(_radian) * _radius - this$1.options.tickRadius + 'px',
              top: this$1.options.dialRadius - Math.cos(_radian) * _radius - this$1.options.tickRadius + 'px'
            });
            _tick.html(_i2 === 0 ? '00' : _i2);
            this$1.hoursView.appendChild(_tick[0]);
            // tick.on(mousedownEvent, mousedown);
          }
        }
      }
      ...
      value: function _buildMinutesView() {
        ...
        for (var i = 0; i < 60; i += 5) {
          ...
          tick.css({
            left: this$1.options.dialRadius + Math.sin(radian) * this$1.options.outerRadius - this$1.options.tickRadius + 'px',
            top: this$1.options.dialRadius - Math.cos(radian) * this$1.options.outerRadius - this$1.options.tickRadius + 'px'
          });
          tick.html(Timepicker._addLeadingZero(i));
          this$1.minutesView.appendChild(tick[0]);
        }
      }
    }, {
  ...
  var Carousel = function (_Component18) {
    ...
    _createClass(Carousel, [{
      ...
      value: function _scroll(x) {
        ...
        for (i = 1; i <= half; ++i) {
          // right side
          if (this$1.options.fullWidth) {
            zTranslation = this$1.options.dist;
            tweenedOpacity = i === half && delta < 0 ? 1 - tween : 1;
          } else {
            zTranslation = this$1.options.dist * (i * 2 + tween * dir);
            tweenedOpacity = 1 - numVisibleOffset * (i * 2 + tween * dir);
          }
          // Don't show wrapped items.
          if (!this$1.noWrap || this$1.center + i < this$1.count) {
            el = this$1.images[this$1._wrap(this$1.center + i)];
            var _transformString = alignment + " translateX(" + (this$1.options.shift + (this$1.dim * i - delta) / 2) + "px) translateZ(" + zTranslation + "px)";
            this$1._updateItemStyle(el, tweenedOpacity, -i, _transformString);
          }
          ...
          // Don't show wrapped items.
          if (!this$1.noWrap || this$1.center - i >= 0) {
            el = this$1.images[this$1._wrap(this$1.center - i)];
            var _transformString2 = alignment + " translateX(" + (-this$1.options.shift + (-this$1.dim * i - delta) / 2) + "px) translateZ(" + zTranslation + "px)";
            this$1._updateItemStyle(el, tweenedOpacity, -i, _transformString2);
          }
        }
